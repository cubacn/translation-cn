...
public class TranscnTestContainer extends TestContainer {

    public TranscnTestContainer() {
        super();
    ...
    public static class Common extends TranscnTestContainer {

        public static final TranscnTestContainer.Common INSTANCE = new TranscnTestContainer.Common();
